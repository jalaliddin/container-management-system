                            ...
                            <di class="row">
                                ...
                                <div class="col border">
                                    <div class="container">
                                        ...
                                        <ol>
                                            <li>
                                                Konteynerning umumiy bahosi: <b>62 000 000 so'm</b>
                                            </li>
                                            <li>To'langan summa: <b>35 000 000 so'm</b>
                                            </li>
                                            <li>
                                                Qolgan summa: <b>27 000 000 so'm</b>
                                            </li>
                                        </ol>
                                        <div class="card border-success mb-3 mx-auto" style="max-width: 18rem;">
                                            ...
                                            <div class="card-body text-success">
                                                ...
                                                <p class="card-text">Bank orqali o'tkazilgan.</p>
                                            </div>
                                            <div class="card-footer bg-transparent border-success">Sana: 27.07.2021
                                            </div>
                                        </div>
                                    </div>
